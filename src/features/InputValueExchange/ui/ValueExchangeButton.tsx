...
export const ValueExchangeButton = ({valueChange} : {valueChange: () => void}) => {
  return (
    <button type="button" onClick={valueChange} className="absolute right-8 top-1/2 -translate-y-1/2 z-[1] w-10 h-10 bg-white border-2 border-[#8e8d8d] rounded-full flex items-center justify-center">
